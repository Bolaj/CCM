...
{
    /// <inheritdoc />
    public partial class AddPermissionAndAttendance : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Permissions_Rehearsals_RehearsalId",
                        column: x => x.RehearsalId,
                        principalTable: "Rehearsals",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Attendances_UserId_RehearsalId",
                table: "Attendances",
                columns: new[] { "UserId", "RehearsalId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Permissions_RehearsalId",
                table: "Permissions",
                column: "RehearsalId");
